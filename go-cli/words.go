...
func registerSDKWords(r *eng.Registry, client *sdk.RemoteJobsSDK) {
...
func runOp(client *sdk.RemoteJobsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
