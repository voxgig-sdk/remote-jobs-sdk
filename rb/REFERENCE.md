# RemoteJobs Ruby SDK Reference

Complete API reference for the RemoteJobs Ruby SDK.
...
#### `RemoteJobsSDK.test(testopts = nil, sdkopts = nil)`
...
| `tags` | `Array` | No | Tags or categories associated with the job |
