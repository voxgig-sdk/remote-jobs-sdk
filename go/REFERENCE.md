# RemoteJobs Golang SDK Reference

Complete API reference for the RemoteJobs Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *RemoteJobsSDK`
...
#### `Job(data map[string]any) RemoteJobsEntity`
...
| `tags` | `[]any` | No | Tags or categories associated with the job |
