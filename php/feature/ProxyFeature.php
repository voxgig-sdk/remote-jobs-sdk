...
class RemoteJobsProxyFeature extends RemoteJobsBaseFeature
{
    ...
    public function init(RemoteJobsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (RemoteJobsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
