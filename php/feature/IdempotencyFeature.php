...
// RemoteJobs SDK idempotency feature
...
class RemoteJobsIdempotencyFeature extends RemoteJobsBaseFeature
{
    ...
    private function _mutating(RemoteJobsContext $ctx): bool
    {
