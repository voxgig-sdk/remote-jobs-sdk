...
class RemoteJobsRbacFeature extends RemoteJobsBaseFeature
{
    ...
    private function _required(RemoteJobsContext $ctx): ?string
    {
    ...
    private function _reject(RemoteJobsContext $ctx, string $required): void
    {
    ...
    private function _track(RemoteJobsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
