...
// RemoteJobs SDK clienttrack feature
...
class RemoteJobsClienttrackFeature extends RemoteJobsBaseFeature
{
    ...
    public function PostConstruct(RemoteJobsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'RemoteJobs-SDK';
