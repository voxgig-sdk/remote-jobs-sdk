...
// RemoteJobs SDK ratelimit feature
...
class RemoteJobsRatelimitFeature extends RemoteJobsBaseFeature
{
    ...
    private function _acquire(RemoteJobsContext $ctx): void
    {
    ...
    private function _track(RemoteJobsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
