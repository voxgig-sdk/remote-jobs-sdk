...
// RemoteJobs SDK utility: fetcher

class RemoteJobsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; RemoteJobsSDK/1.0)';
    ...
    public static function call(RemoteJobsContext $ctx, string $fullurl, array $fetchdef): array
    {
