...
// RemoteJobs SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class RemoteJobsMakeRequest
{
    public static function call(RemoteJobsContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new RemoteJobsResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new RemoteJobsResponse($fetched);
        } else {
