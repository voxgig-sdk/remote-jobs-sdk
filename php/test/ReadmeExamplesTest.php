...
// RemoteJobs SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (RemoteJobsSDK::test)
...
{
    private const SDK_CLASS = 'RemoteJobsSDK';
    ...
    private const SDK_BASE = 'remotejobs_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../remotejobs_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
