# RemoteJobs SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions RemoteJobsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both RemoteJobsSDK(...) and RemoteJobsSDK.test(...) become
#      RemoteJobsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "remotejobs_sdk"
_SDK_CLASS = "RemoteJobsSDK"
