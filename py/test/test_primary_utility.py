...
from remotejobs_sdk.core.spec import RemoteJobsSpec
from remotejobs_sdk.core.result import RemoteJobsResult
from remotejobs_sdk.core.response import RemoteJobsResponse
from remotejobs_sdk.core.operation import RemoteJobsOperation
from remotejobs_sdk.core.error import RemoteJobsError
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return RemoteJobsError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = RemoteJobsSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = RemoteJobsSDK.test(None, None)
        ...
        class TestInitFeature(RemoteJobsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(RemoteJobsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = RemoteJobsSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = RemoteJobsSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = RemoteJobsSDK.test(None, setup_opts)
