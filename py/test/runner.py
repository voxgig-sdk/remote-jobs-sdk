...
class RemoteJobsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = RemoteJobsTestRunner.getenv("REMOTEJOBS_TEST_LIVE")
        override = RemoteJobsTestRunner.getenv("REMOTEJOBS_TEST_OVERRIDE")
        ...
        explain = RemoteJobsTestRunner.getenv("REMOTEJOBS_TEST_EXPLAIN")
