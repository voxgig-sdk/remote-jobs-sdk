...
from remotejobs_sdk.core.control import RemoteJobsControl
...
from remotejobs_sdk.core.helpers import get_ctx_prop, to_map
...
class RemoteJobsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, RemoteJobsSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, RemoteJobsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, RemoteJobsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return RemoteJobsError(code, msg, self)
