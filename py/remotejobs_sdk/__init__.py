...
from remotejobs_sdk.utility import register

# Load features
from remotejobs_sdk.feature.base_feature import RemoteJobsBaseFeature
from remotejobs_sdk.features import _has_feature, _make_feature
...
class RemoteJobsSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = RemoteJobsUtility()
        self._utility = utility

        from remotejobs_sdk.config import shared_config
    ...
    def get_utility(self):
        return RemoteJobsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("RemoteJobsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Job(self, data=None) -> "JobEntity":
        ...
        from remotejobs_sdk.entity.job_entity import JobEntity
        return JobEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "RemoteJobsSDK":
        if sdkopts is None:
            sdkopts = {}
