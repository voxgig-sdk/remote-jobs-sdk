...
|---|---|---|
| `ts/` | @voxgig-sdk/remote-jobs-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/remote-jobs-sdk \
      --repository voxgig-sdk/remote-jobs-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/remote-jobs-sdk` shows it, and
`npm trust revoke @voxgig-sdk/remote-jobs-sdk --id=<id>` removes it.
