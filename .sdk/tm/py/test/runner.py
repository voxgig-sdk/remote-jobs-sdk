...
class RemoteJobsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = RemoteJobsTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = RemoteJobsTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = RemoteJobsTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
