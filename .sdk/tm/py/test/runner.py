...
class RemoteJobsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = RemoteJobsTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = RemoteJobsTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = RemoteJobsTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
