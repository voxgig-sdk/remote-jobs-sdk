...
// RemoteJobs SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = RemoteJobsOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(RemoteJobsOmni::structfix($now, Struct::undef()))
                        !== json_encode(RemoteJobsOmni::structfix($val, Struct::undef()))) {
