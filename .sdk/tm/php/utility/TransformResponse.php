...
// RemoteJobs SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class RemoteJobsTransformResponse
{
    public static function call(RemoteJobsContext $ctx): mixed
    {
        ...
        $transform = RemoteJobsHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
