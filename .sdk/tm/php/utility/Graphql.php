...
// RemoteJobs SDK utility: graphql
//
...
class RemoteJobsGraphql
{
    ...
    // equivalent.
    public static function body(RemoteJobsContext $ctx): mixed
    {
    ...
    public static function errors(RemoteJobsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
