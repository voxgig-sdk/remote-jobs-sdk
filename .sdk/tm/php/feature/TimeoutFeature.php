...
// RemoteJobs SDK timeout feature
...
class RemoteJobsTimeoutFeature extends RemoteJobsBaseFeature
{
    ...
    private function _with_timeout(RemoteJobsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(RemoteJobsContext $_ctx, float $ms): void
    {
        $client = $this->client;
