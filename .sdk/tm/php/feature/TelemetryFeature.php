...
// RemoteJobs SDK telemetry feature
...
class RemoteJobsTelemetryFeature extends RemoteJobsBaseFeature
{
    ...
    private function _close(RemoteJobsContext $ctx, bool $ok): void
    {
