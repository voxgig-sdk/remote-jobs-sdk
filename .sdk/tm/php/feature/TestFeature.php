...
// RemoteJobs SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class RemoteJobsTestFeature extends RemoteJobsBaseFeature
{
    ...
    public function init(RemoteJobsContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (RemoteJobsContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = RemoteJobsParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (RemoteJobsContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(RemoteJobsContext $ctx, $op, $args): array
    {
