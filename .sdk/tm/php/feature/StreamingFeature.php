...
// RemoteJobs SDK streaming feature
...
class RemoteJobsStreamingFeature extends RemoteJobsBaseFeature
{
    ...
    private function _iterate(RemoteJobsResult $result): \Generator
    {
    ...
    private function _streamable(RemoteJobsContext $ctx): bool
    {
