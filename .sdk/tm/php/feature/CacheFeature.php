...
class RemoteJobsCacheFeature extends RemoteJobsBaseFeature
{
    ...
    private function _through(RemoteJobsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
