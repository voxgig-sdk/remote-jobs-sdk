# RemoteJobs TypeScript SDK Reference

Complete API reference for the RemoteJobs TypeScript SDK.
...
```ts
new RemoteJobsSDK(options?: object)
```
...
#### `RemoteJobsSDK.test(testopts?, sdkopts?)`
...
**Returns:** `RemoteJobsSDK` instance in test mode.
...
Return the parent `RemoteJobsSDK` instance.
