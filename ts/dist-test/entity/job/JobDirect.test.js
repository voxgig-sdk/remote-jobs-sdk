...
(0, node_test_1.describe)('JobDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.RemoteJobsSDK({
...
function liveScenariosActive() { return false && process.env.REMOTE_JOBS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.RemoteJobsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['REMOTE_JOBS_TEST_JOB_ENTID'];
    ...
    const client = new __1.RemoteJobsSDK({
        base: 'http://localhost:8080',
