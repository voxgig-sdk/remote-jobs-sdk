...
function envOverride(m) {
    if ('TRUE' === process.env.REMOTE_JOBS_TEST_LIVE ||
        'TRUE' === process.env.REMOTE_JOBS_TEST_OVERRIDE) {
    ...
    m.REMOTE_JOBS_TEST_EXPLAIN = process.env.REMOTE_JOBS_TEST_EXPLAIN || m.REMOTE_JOBS_TEST_EXPLAIN;
    return m;
}
