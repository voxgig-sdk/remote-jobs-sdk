...
import { RemoteJobsSDK, BaseFeature, stdutil } from '../../..'
...
function basicSetup(extra?: any) {
  ...
  let client = RemoteJobsSDK.test(options, extra)
  ...
  if (live) {
    ...
    client = new RemoteJobsSDK(merge([
