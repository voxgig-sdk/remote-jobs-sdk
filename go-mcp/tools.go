...
func registerTools(server *mcp.Server, client *sdk.RemoteJobsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "remote-jobs_list",
		Description: "List records from RemoteJobs. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "remote-jobs_load",
		Description: "Load a single record from RemoteJobs. " +
...
func runOp(client *sdk.RemoteJobsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.RemoteJobsSDK, name string) (sdk.RemoteJobsEntity, error) {
