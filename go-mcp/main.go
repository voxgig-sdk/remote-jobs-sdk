// Command RemoteJobs-mcp is an MCP server exposing the RemoteJobs
// SDK as MCP tools.
//
// Two tools are registered:
//
//	RemoteJobs_list  — list records of an entity
//	RemoteJobs_load  — load a single record of an entity
//
